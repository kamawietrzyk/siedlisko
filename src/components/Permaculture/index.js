...
const Permaculture = () => (
  <>
    ...
    <div className="Permaculture">
      ...
      <p><span>Bill Mollison</span> -  australijski badacz, autor, naukowiec, wykładowca i naturalista, uważany za ojca permakultury - w 1978r. stworzył definicję, która mówi, że &ldquo;system jest zrównoważony wtedy, gdy w ciągu swojego istnienia wytwarza conajmniej tyle energii, ile jej zużywa&ldquo;. W książce pt. &ldquo;Wprowadzenie do permakultury&ldquo; (polskie wydanie dostępne <a href="https://permakultura.edu.pl/wprowadzenie-do-permakultury/">tutaj</a>) Mollison mówi o permakulturze tak:</p>
      <p className="Permaculture__blockquote">Permakultura jest systemem projektowania, w którym tworzy się trwałe środowiska ludzkie. Słowo &quot;permakultura&quot; powstało z połączenia słowa <span>permanent</span> (&quot;trwałe&quot;, łac. <em>permaneo</em> - &quot;wytrwać&quot; i &quot;utrzymać się&quot;) ze słowem <span>agriculture</span> (&quot;rolnictwo&quot;), a także słowem <em>culture</em> (&quot;kultura&quot;, łac. <em>cultura</em> - &quot;uprawa&quot;, &quot;hodowla&quot;), ponieważ kultura nie może przetrwać bez zrównoważonej bazy rolniczej i etyki użytkowania ziemi. Z jednej strony permakultura zajmuje się roślinami, zwierzętami, budynkami i infrastrukturą (wodną, energetyczną, komunikacyjną), z drugiej nie traktuje o tych elementach ze względu na nie same, lecz ze względu na związki, jakie możemy między nimi ustanowić dzięki odpowiedniemu rozmieszczeniu ich w terenie. <br/>
      Celem tak rozumianej permakultury jest tworzenie przyjaznych dla środowiska i ekonomicznie wydajnych systemów, zaspokajających własne potrzeby, nieeksploatujących ani niezanieczyszczających otoczenia, a co za tym idzie - długotrwałych.</p>
      <div className="Permaculture__two">
        <img className="spiral" src={herbSpiral} alt="herb-spiral" width="75%"/>
        <p>Te ryciny przedstawiają dwa z bardzo wielu elementów charakterystycznych dla projektów permakulturowych - obrazek po lewej to przydomowa <span>spirala ziołowa</span>, obrazek po prawej - <span>gildia drzewa owocowego</span> wraz z opisem funkcji roślin towarzyszących.</p>
      ...
      <p className="mt-4">Permakulturowe zasady etyczne oraz 12 zasad projektowania pięknie przedstawia poniższa grafika, a szczegółowy opis każdej z zasad znajdziesz na stronie <a href="https://permacultureprinciples.com/">PermaculturePrinciples.com</a> - do pobrania broszura również w polskiej wersji językowej.</p>
      <img className="Permaculture__pic" src={wheel} alt="holmgren-permaculture-basics" width="85%" />
      <p>W Polsce ruch permakulturowy rozwija się coraz prężniej, według nas najbardziej przyczyniają się do tego rozwoju panowie <span>Wojciech Górny</span> (<a href="https://permisie.pl/">Permisie.pl</a>) i <span>Bez Lazar</span> (<a href="https://permakultura.edu.pl/">Permakultura.edu.pl</a>). Obaj posiadają ogromną wiedzę, którą chętnie się dzielą z początkującymi pasjonatami permakultury, a na prowadzonych przez nich platformach znajdziesz mnóstwo szczegółowych informacji, linki do literatury fachowej (w tym polskie wydania &ldquo;Ogrodu Gai&ldquo; Toby`ego Hemenwaya oraz wspomniane już wcześniej &ldquo;Wprowadzenie do permakultury&ldquo; Billa Mollisona & Reny M. Slay), kursy projektowania, webinary i wiele, wiele innych.</p>
      <p className="mt-4">Na koniec odrobina filozofii - bo permakultura to nie tylko projekty, zasady, planowanie, wyliczenia, nasadzenia... To także - a może właśnie przede wszystkim - <span>idea</span>. Wojciech Górny w artykule pt. &ldquo;Perma co? Jaka kultura?&ldquo; (całość do przeczytania w <a href="https://permakultura.edu.pl/wp-content/uploads/2wyTworcy.pdf">Magazynie WyTwórcy</a>, #02/15) opisuje ją tak:</p>
