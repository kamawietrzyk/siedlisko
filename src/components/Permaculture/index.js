...
const Permaculture = () => (
  <>
    ...
    <div className="Permaculture">
      ...
      <p><span>Bill Mollison</span> -  australijski badacz, autor, naukowiec, wykładowca i naturalista, uważany za ojca permakultury - w 1978r. stworzył definicję, <br/> która mówi, że &ldquo;system jest zrównoważony wtedy, gdy w ciągu swojego istnienia wytwarza conajmniej tyle energii, ile jej zużywa&ldquo;. W książce <br/> pt. &ldquo;Wprowadzenie do permakultury&ldquo; (polskie wydanie dostępne <a href="https://permakultura.edu.pl/wprowadzenie-do-permakultury/" target="_blank" rel="noopener noreferrer">tutaj</a>) Mollison mówi o permakulturze tak:</p>
      ...
      <div className="Permaculture__two">
        ...
        <p className="text-justify">Te ryciny przedstawiają dwa z bardzo wielu elementów charakterystycznych dla projektów permakulturowych - obrazek po lewej to przydomowa <span>spirala ziołowa</span>, obrazek po prawej - <span>gildia drzewa owocowego</span> wraz z opisem funkcji roślin towarzyszących.</p>
